...
const {
  createOleada, listOleadas, getOleadasDashboard, getDailyUsage, getOleadaDetail, listOleadaRecipients,
...
router.get('/dashboard', auth, requireCorreoAccess, getOleadasDashboard);
