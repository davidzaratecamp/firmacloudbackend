...
const vitalApiKeyOrAuth = require('../middleware/vitalApiKeyOrAuth');
...
// send-with-data (módulo Vital): acepta JWT (panel), VITAL_API_KEY (intranet Vital, nueva)
// o API_KEY (intranet Obama legado, compatibilidad) — ver vitalApiKeyOrAuth.js.
router.post('/send-with-data', vitalApiKeyOrAuth, requireFirmaAccess, sendDocumentWithData);
...
router.get('/:id/download', vitalApiKeyOrAuth, requireFirmaAccess, downloadSignedDocument);
...
router.get('/:id', vitalApiKeyOrAuth, requireFirmaAccess, getSignature);
